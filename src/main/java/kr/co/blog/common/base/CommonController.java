...
import kr.co.blog.common.response.ResponsePaginationBodyVO;
...
public abstract class CommonController {
	...
	protected CommonResultDataVO getSuccessCode() {
		String resultStr = messageSource.getMessage("RESULT.OK", null, new Locale("en"));
	...
	protected CommonResultDataVO getFailCode() {
		String resultStr = messageSource.getMessage("RESULT.FAIL", null, new Locale("en"));
		CommonResultDataVO result = new CommonResultDataVO();
		result.setResult(resultStr);
